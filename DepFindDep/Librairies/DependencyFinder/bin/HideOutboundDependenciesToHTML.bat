...
"%JAVA_HOME%\bin\java" %DEPENDENCYFINDER_OPTS% -classpath "%DEPENDENCYFINDER_HOME%\classes;%DEPENDENCYFINDER_HOME%\lib\DependencyFinder.jar;%DEPENDENCYFINDER_HOME%\lib\log4j.jar;%DEPENDENCYFINDER_HOME%\lib\jakarta-oro.jar" com.jeantessier.dependencyfinder.cli.XSLTProcess -xsl "%DEPENDENCYFINDER_HOME%\etc\HideOutboundDependenciesToHTML.xsl" %DEPENDENCYFINDER_CMD_LINE_ARGS%
